...
- A "good" representation of the data is one where (1) weights are selected based on a global minima in gradient descent and (2) resulting representations improve overall prediction accuracy. 
